...
from ali.streams import create_mnist_08_data_streams
...
def create_model_brick():
    layers = [
        #conv_brick(5, 1, 28), bn_brick(), LeakyRectifier(),
        conv_brick(4, 2, 56), bn_brick(), LeakyRectifier(),
        conv_brick(4, 1, 112), bn_brick(), LeakyRectifier(),
        conv_brick(4, 2, 224), bn_brick(), LeakyRectifier(),
        conv_brick(4, 1, 448), bn_brick(), LeakyRectifier(),
        conv_brick(1, 1, 448), bn_brick(), LeakyRectifier(),
    ...
    layers = [
        conv_transpose_brick(4, 1, 224), bn_brick(), LeakyRectifier(),
        conv_transpose_brick(4, 2, 112), bn_brick(), LeakyRectifier(),
        conv_transpose_brick(4, 1, 56), bn_brick(), LeakyRectifier(),
        conv_transpose_brick(4, 2, 28), bn_brick(), LeakyRectifier(),
        #conv_transpose_brick(5, 1, 28), bn_brick(), LeakyRectifier(),
        conv_transpose_brick(1, 1, 28), bn_brick(), LeakyRectifier(),
    ...
    layers = [
        #conv_brick(5, 1, 28), LeakyRectifier(),
        conv_brick(4, 2, 56), bn_brick(), LeakyRectifier(),
        conv_brick(4, 1, 112), bn_brick(), LeakyRectifier(),
        conv_brick(4, 2, 224), bn_brick(), LeakyRectifier(),
        conv_brick(4, 1, 448), bn_brick(), LeakyRectifier()]
    ...
    layers = [
        conv_brick(1, 1, 512), LeakyRectifier(),
        conv_brick(1, 1, 512), LeakyRectifier()]
    ...
    layers = [
        conv_brick(1, 1, 1024), LeakyRectifier(),
        conv_brick(1, 1, 1024), LeakyRectifier(),
        conv_brick(1, 1, 1)]
    ...
    ali.initialize()
    raw_marginals, = next(
        create_mnist_08_data_streams(500, 500)[0].get_epoch_iterator())
...
def create_models():
    ...
    def _create_model(with_dropout):
        ...
        if with_dropout:
            ...
            cg = apply_dropout(cg, inputs, 0.4)
...
def create_main_loop(save_path, backup_path):
    ...
    streams = create_mnist_08_data_streams(BATCH_SIZE, MONITORING_BATCH_SIZE)
    ...
    extensions = [
        ...
        PlotLoss(backup_path, "ALI MNIST 0, 8", every_n_epochs=5, after_training=True),
        PlotAccuracy(backup_path, "ALI MNIST 0, 8", every_n_epochs=5, after_training=True),
        ProgressBar(),
        Printing(),
    ]
