...
from ali.streams import create_svhn_108_data_streams
...
def create_model_brick():
    ...
    ali.initialize()
    raw_marginals, = next(
        create_svhn_108_data_streams(500, 500)[0].get_epoch_iterator())
